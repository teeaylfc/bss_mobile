          ...
          title: Padding(
            ...
            child: Container(
              ...
              child: TextField(
                ...
                style: new TextStyle(color: Color(0xFF898989), fontSize: ScreenUtil().setSp(14)),
                textInputAction: TextInputAction.search,
                onSubmitted: (String _) {
                  widget.delegate.showResults(context);
                },
                decoration: InputDecoration(
                  hintText: 'Nhập thương hiệu và dịch vụ bạn tìm kiếm',
                  border: InputBorder.none,
                  contentPadding: EdgeInsets.fromLTRB(0, 10, 0, 0),
                  hintStyle: TextStyle(color: Color(0xFFB1B1B1), fontSize: ScreenUtil().setSp(14)),
                  prefixIcon: Padding(
                  ...
                  suffixIcon: queryTextController.text.length > 0
                      ? IconButton(
                          onPressed: () {
