...
import 'package:bss_mobile/src/models/branch_model.dart';
import 'package:bss_mobile/src/models/category_model.dart';
import 'package:bss_mobile/src/models/item_cms_model.dart';
import 'package:bss_mobile/src/models/item_detail_model.dart';
import 'package:bss_mobile/src/models/item_model.dart';
import 'package:bss_mobile/src/models/list_address_model.dart';
import 'package:bss_mobile/src/models/list_item_model.dart';
import 'package:bss_mobile/src/models/list_redeem_history_model.dart';
import 'package:bss_mobile/src/models/list_review_model.dart';
import 'package:bss_mobile/src/models/list_stadium_model.dart';
...
class DataService {
  ...
  Future<dynamic> getCity() async {
    final response =
        await httpManager.get('$_baseApiBss' + 'location/city', null);
    return response;
  }

  Future<dynamic> getDistrict(cityId) async {
    final response =
        await httpManager.get('$_baseApiBss' + 'location/city/$cityId', null);
    return response['districtDTOs'];
  }

  Future<dynamic> getCommune(districtId) async {
    final response = await httpManager.get(
        '$_baseApiBss' + 'location/district/$districtId', null);
  ...
  Future<AccountInfo> upLoadAvatar(File file) async {
    ...
    final response =
        await httpManager.put('$_baseApiBss' + 'users/update/image', formData);
    return AccountInfo.fromJson(response['data']['accountInfo']);
  }

  Future<ListAddress> getAllAdress() async {
    final response =
        await httpManager.get('$_baseApiBss' + 'address/all', null);
  ...
  Future<dynamic> creatAddress(name, specificAddress, description, matp, maqh,
      xaid, stadiumDTOs, shiftDTOs) async {
    final body = {
      "name": name,
    ...
    final response =
        await httpManager.post('$_baseApiBss' + 'address/register', body);
    return response;
  }

  Future<dynamic> deleteAddress(id) async {
    final response =
        await httpManager.delete('$_baseApiBss' + 'address/delete/$id', null);
    return response;
  }

  Future<dynamic> getConfirm() async {
    final response =
        await httpManager.get('$_baseApiBss' + 'stadiums/confirm', null);
    return response['data']['address'];
  }

  Future<dynamic> updateStatus(id, status, note) async {
    final body = {"id": id, "status": status, "note": note};
    final response =
        await httpManager.put('$_baseApiBss' + 'statusshift/update', body);
    return response['data'];
  }

  Future<dynamic> bookShift(id, date) async {
    final body = {"shiftDTO": id, "date": date};
    final response =
  ...
  Future<dynamic> checkEmailExist(email) async {
    final response = await httpManager.get(
        '$_cywEndpoint/customer/$distributorId?email=$email', null);
    return (response['data']);
  }
  ...
  Future<AccountInfo> updateProfile(fullName, phone, gender) async {
    ...
    final response =
        await httpManager.put('$_baseApiBss' + 'users/update', dataJson);
    return AccountInfo.fromJson(response['data']['accountInfo']);
  }

  Future<bool> isFirstPassword() async {
    final response = await httpManager.get(
        '$_cywEndpoint/check-login/password_default', null);
    return (response['data']);
  }
  ...
  Future<dynamic> changePassword(oldPassword, newPassword) async {
    ...
    final response = await httpManager.post(
        '$_baseEndpoint' + 'api/mobile/cyw/customer/change_password', body);
    return (response['data']);
  }
  ...
  Future<String> forgotPasswordInit(email) async {
    ...
    final response = await httpManager.post(
        '$_baseEndpoint' + 'api_mobile/customer/reset_password/init', body);
    return (response['data']);
  }
  ...
  Future<String> forgotPasswordFinish(email, key, newPassword) async {
    ...
    final response = await httpManager.post(
        '$_baseEndpoint' + 'api_mobile/customer/reset_password/finish', body);
    return (response['data']);
  }

  Future<ListItem> getHotItem(page) async {
    final response = await httpManager.get(
        '$_mbfEndpoint/items/hot?page=$page&size=$size', null);
  ...
  Future<ListItem> getNewestItem(page) async {
    final response = await httpManager.get(
        '$_mbfEndpoint/items/newest?page=$page&size=$size', null);
    return ListItem.fromJson(response);
  }

  Future<ListItem> getFavoritesItem(page) async {
    final response = await httpManager.get(
        '$_mbfEndpoint/items/my-favorites?page=$page&size=$size', null);
    return ListItem.fromJson(response);
  }

  Future<ListMyReward> getMyReward(page) async {
    final response = await httpManager.get(
        '$_mbfEndpoint/my-rewards?lang=en&page=$page&size=$size', null);
    return ListMyReward.fromJson(response);
  }

  Future<int> countWallet() async {
    final response = await httpManager.get(
        '$_apiEndpoint/customer/offer_count_in_wallet', null);
    return (response['data']);
  }
  ...
  Future<ListReview> getListReview(companyId, page) async {
    final response = await httpManager.get(
        '$_cywEndpoint/reviews/company/$distributorId/$companyId?page=$page&size=$size',
        null);
  ...
  Future<ListItem> getViewNearlyItem(page) async {
    final response = await httpManager.get(
        '$_mbfEndpoint/items/view-nearly?page=$page&size=$size', null);
    return ListItem.fromJson(response);
  }
  ...
  Future<ListItem> getFavorites() async {
    final response = await httpManager.get(
        '$_cywEndpoint/offers/your_favorite/$distributorId', null);
  ...
  Future<CategoryList> getAllCategory() async {
    var response =
        await httpManager.get('$_mbfEndpoint/categories?lang=vi', null);
    print(response);
  ...
  Future<ListItem> getItemByCategory(categoryCode, page) async {
    final size = Config.PAGE_SIZE;
    final response = await httpManager.get(
        '$_mbfEndpoint/categories/$categoryCode/items?page=$page&size=$size',
        null);
    return ListItem.fromJson(response);
  }
  ...
  Future<List<Category>> getBrowserCategory(page) async {
    final response =
        await httpManager.get('$_mbfEndpoint/items/group-category', null);
    print(response);
    List<Category> categories =
        (response as List).map((model) => Category.fromJson(model)).toList();
    return categories;
  }
  ...
  Future<Item> getItemDetail(itemCode) async {
    final response =
        await httpManager.get('$_mbfEndpoint/items/$itemCode', null);
  ...
  Future<ListItem> getInterestingItem(page) async {
    final size = Config.PAGE_SIZE;
    final response = await httpManager.get(
        '$_mbfEndpoint/items/interesting?page=$page&size=$size', null);
    return ListItem.fromJson(response);
  }

  Future<dynamic> getQrCode(voucherCode) async {
    final response = await httpManager.get(
        '$_mbfEndpoint/rewards/$voucherCode/qrCode', null);
    return response;
  }
  ...
  Future<ListItem> getListItemBookingRewards(status, page) async {
    final size = Config.PAGE_SIZE;
    final response = await httpManager.get(
        '$_cywEndpoint/offers/explore/$distributorId/$status?page=$page&size=$size',
        null);
    return ListItem.fromJson(response['data']);
  }
  ...
  Future<dynamic> addOffersToWallet(offerIds) async {
    ...
    final response =
        await httpManager.put('$_apiEndpoint/customer/wallet', jsonRequest);
    return response['data'];
  }

  Future<dynamic> removeItemFromWallet(ItemId, status) async {
    final response = await httpManager.post(
        '$_apiEndpoint/customer/remove_wallet/$distributorId/$ItemId/$status',
        null);
    return response['data'];
  }
  ...
  Future<dynamic> payAtTable(offerIds, qrcode) async {
    ...
    final response = await httpManager.post(
        '$_baseEndpoint/api/redeem_pay_at_table', jsonRequest);
    return response['data'];
  }
  ...
  Future<dynamic> receiptDataCertificate(qrCode) async {
    ...
    final response = await httpManager.post(
        '$_apiEndpoint/customer/receipt_certificate/', dataJson);
    return response['data'];
  }
  ...
  Future<dynamic> receiptDataCertificatePayAtTable(qrCode) async {
    final dataJson = {"qr": qrCode};
    final response = await httpManager.post(
        '$_baseEndpoint/api/redeem_pay_at_table_end_offline', dataJson);
    return response['data'];
  }
  ...
  Future<Review> writeComment(companyId, rate, tittle, review) async {
    ...
    final response = await httpManager.post(
        '$_cywEndpoint/reviews/$distributorId', jsonRequest);
  ...
  Future<Item> likeItem(itemCode) async {
    final response =
        await httpManager.post('$_mbfEndpoint/items/$itemCode/favorites', null);
    return Item.fromJson(response);
  }
  ...
  Future<Branch> likeBranch(brancheId) async {
    final response = await httpManager.post(
        '$_mbfEndpoint/branches/$brancheId/favorites', null);
  ...
  Future<Store> likeStore(storeId) async {
    final response =
        await httpManager.post('$_mbfEndpoint/stores/$storeId/favorites', null);
    return Store.fromJson(response);
  }

  // booking
  Future<Booking> book(ItemId, fulfillmentPartnerId, bookingDate, quantityAdult,
      quantityChildren, String note) async {
    final jsonRequest = {
      'offerId': ItemId,
    ...
    final response = await httpManager.post(
        '$_cywEndpoint/bookings/$distributorId', jsonRequest);
    return Booking.fromJson(response['data']);
  }

  // edit booking
  Future<Booking> editBooking(id, ItemId, fulfillmentPartnerId, bookingDate,
      quantityAdult, quantityChildren, String note) async {
    final jsonRequest = {
      'id': id,
      'offerId': ItemId,
      'fulfillmentPartnerId': fulfillmentPartnerId,
  ...
  Future<BookingList> getBooking(page, status) async {
    final response = await httpManager.get(
        '$_cywEndpoint/bookings/consumer/$distributorId/$status/?page=$page&size=$size',
        null);
  ...
  Future<dynamic> cancelBooking(id) async {
    final response = await httpManager.put(
        '$_cywEndpoint/bookings/cancel-consumer/$id', null);
    return response['data'];
  }
  ...
  Future<dynamic> deleteBooking(id) async {
    final response =
        await httpManager.delete('$_cywEndpoint/bookings/$id', null);
    return response['data'];
  }

  Future<dynamic> selectItemOffline(offerIds, storeId) async {
    final response = await httpManager.post(
        '$_apiEndpoint/customer/select_offers_offline/$distributorId/$storeId',
        offerIds);
    return response['data'];
  }
  ...
  Future<ListItem> search(keyword, page) async {
    final response = await httpManager.get(
        '$_mbfEndpoint/items?query=$keyword&page=$page', null);
    return ListItem.fromJson(response);
  }
  ...
  Future<dynamic> searchHistory() async {
    final response =
        await httpManager.get('$_apiEndpoint/customer/search_history', null);
    return response['data'];
  }
  ...
  Future<dynamic> clearSearchHistory() async {
    final response =
        await httpManager.delete('$_apiEndpoint/customer/search_history', null);
    return response['data'];
  }
  ...
  Future<dynamic> searchSuggestion(keyword, limit) async {
    final response = await httpManager.get(
        '$_cywEndpoint/customer/search_suggestion_history?limit=$limit&keyword=$keyword',
        null);
    print(response['data']);
    return response['data'];
  }
  ...
  Future<ListTransaction> getTransactionHistory(page, fromDate, toDate) async {
    final response = await httpManager.get(
        '$_mbfEndpoint/transaction-history?fromDate=$fromDate&toDate=$toDate&lang=vi&page=$page',
        null);
  ...
  Future<ListRedeemHistory> getListRedeemHistory(page, fromDate, toDate) async {
    final response = await httpManager.get(
        '$_mbfEndpoint/redeem-history?fromDate=$fromDate&toDate=$toDate&lang=vi&page=$page',
        null);
  ...
  Future<Transaction> getTransactionHistoryDetail(id) async {
    final response = await httpManager.get(
        '$_cywEndpoint/customer/transaction_history/$id', null);
  ...
  Future<dynamic> registerDevice(os, osVersion, tokenId, deviceName) async {
    ...
    final response =
        await httpManager.post('$_apiEndpoint/customer/device', jsonRequest);
    return response;
  }
  ...
  Future<dynamic> deleteDevice(tokenId) async {
    ...
    final response =
        await httpManager.delete('$_apiEndpoint/customer/device', jsonRequest);
    return response;
  }
  ...
  Future<ListItem> filterWallets(
      page, ItemType, storeId, brandId, distance, latitude, longitude) async {
    var jsonRequest = {};
    final response = await httpManager.post(
        '$_apiEndpoint/customer/filter_wallet/$distributorId?page=$page&size=$size',
        jsonRequest);
  ...
  Future<ListMobileNotification> getNotification(page) async {
    final response = await httpManager.get(
        '$_mbfEndpoint/user/notifications?page=$page&size=$size', null);
  ...
  Future<dynamic> countNotification() async {
    final response = await httpManager.get(
        '$_apiEndpoint/customer/notifications/count', null);
    return response['data'];
  }
  ...
  Future<dynamic> deleteNotification(notificationIds) async {
    final response = await httpManager.delete(
        '$_mbfEndpoint/user/notifications', notificationIds);
    return response;
  }
  ...
  Future<dynamic> updateNotificationStatus(id) async {
    final response = await httpManager.put(
        '$_apiEndpoint/customer/notifications/status/$id', null);
    return response['data'];
  }
  ...
  Future<AccountInfo> getBalance() async {
    final response =
        await httpManager.get('$_mbfEndpoint/account/balance', null);
  ...
  Future<bool> prepareCheckout(itemCodeList) async {
    final response = await httpManager.post(
        '$_mbfEndpoint/cart/checkout/prepare', itemCodeList);
    return response['needShippingAddress'];
  }

  Future<dynamic> checkoutCart(itemCodeList, shippingAddress) async {
    final body = {"item": itemCodeList, "shippingAddress": shippingAddress};
    final response =
        await httpManager.post('$_mbfEndpoint/cart/checkout', body);
    return response;
  }
  ...
  Future<Store> getStoreDetail(storeId) async {
    final response =
        await httpManager.get('$_mbfEndpoint/stores/$storeId', null);
    return Store.fromJson(response);
  }
  ...
  Future<ListItem> getStoreItem(storeId) async {
    final response =
        await httpManager.get('$_mbfEndpoint/stores/$storeId/items', null);
    return ListItem.fromJson(response);
  }
  ...
  Future<OrderList> addCartAfterLogin(jsonRequest) async {
    final response =
        await httpManager.post('$_mbfEndpoint/cart/sync', jsonRequest);
  ...
  Future<OrderList> removeCart(itemCode) async {
    final response =
        await httpManager.post('$_mbfEndpoint/cart/$itemCode/remove', null);
    return OrderList.fromJson(response);
  }
  ...
  Future<OrderList> addOrUpdateCart(itemCode, jsonRequest) async {
    ...
    final response =
        await httpManager.post('$_mbfEndpoint/cart/$itemCode', jsonRequest);
    return OrderList.fromJson(response);
  }

  Future<ItemCms> getCmsFaq(lang, page) async {
    final response = await httpManager.get(
        '$_mbfEndpoint/cms/faq?lang=$lang&page=$page&size=$size', null);
    return ItemCms.fromJson(response);
  }

  Future<ItemCms> getCmsTac(lang, page) async {
    final response = await httpManager.get(
        '$_mbfEndpoint/cms/tac?lang=$lang&page=$page&size=$size', null);
    return ItemCms.fromJson(response);
  }

  Future<ItemCms> getCmsAboutMbf(lang, page) async {
    final response = await httpManager.get(
        '$_mbfEndpoint/cms/about?lang=$lang&page=$page&size=$size', null);
    return ItemCms.fromJson(response);
  }

  Future<dynamic> sendFeedback(jsonRequest) async {
    final response =
        await httpManager.post('$_mbfEndpoint/feedback', jsonRequest);
    return response;
  }
}
