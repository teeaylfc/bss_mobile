      ...
      body: SmartRefresher(
        ...
        child: listConfirm != []
                              ...
                              child: Row(
                                children: <Widget>[
                                  ...
                                  Column(
                                    ...
                                    children: <Widget>[
                                      Text(
                                        shift.addressDTO.name ?? '',
                                        style: TextStyle(
                                            color: CommonColor.textBlack,
                                            fontSize: ScreenUtil().setSp(15)),
                                      ),
                                      Text(
                                        shift.stadiumDTO.name ?? '',
                                        style: TextStyle(
                                            color: CommonColor.textBlack,
                                            fontSize: ScreenUtil().setSp(15)),
                                      ),
                                      Text(
                                        shift.shiftDTO.time_start +
                                            " - " +
                                            shift.shiftDTO.time_end,
                                        style: TextStyle(
                                            color: CommonColor.textBlack,
                                            fontSize: ScreenUtil().setSp(15),
            ...
            : Container(
                child: Center(
                    child: Text(
                  "Hiện không có lịch đặt nào cần phải xác nhận",
                  style: TextStyle(
                    color: CommonColor.textBlack,
