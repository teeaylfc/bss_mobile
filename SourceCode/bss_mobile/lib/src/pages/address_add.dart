...
import 'package:bss_mobile/src/pages/address_add_2.dart';
import 'package:bss_mobile/src/pages/choose_city_district.dart';
...
@override
              ...
              child: Expanded(
                child: ListView(
                  children: <Widget>[
                    ...
                    _inputText(context, description, TextInputType.text, 'Mô tả',maxLine: 3),
                  ],
                ),
              ),
            ),
  ...
  Widget _inputText(context, controller, keyboardType, label,{maxLine}) {
    final width = MediaQuery.of(context).size.width;
    return Container(
      width: width,
      margin: EdgeInsets.only(
